...
const AboutUs = () => {
  return (
    <section className="py-16 rounded-lg  mt-12">
      <h2 className="text-4xl font-poppins font-bold text-white text-center mb-4">
        About Us
      </h2>
      <p className="text-lg font-lora text-gray-100 text-justify leading-relaxed max-w-6xl mx-auto pt-12">
